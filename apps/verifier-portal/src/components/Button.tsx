/**
 * Button Component for Verifier Portal
 *
 * A versatile button component with multiple variants:
 * - default: Solid red background (primary actions)
 * - destructive: Solid darker red background (critical actions)
...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles = {
      ...
      outline:
        "bg-transparent border-2 border-[#e11d48] text-[#e11d48] hover:bg-[#e11d48] hover:text-white focus:ring-[#e11d48]",
    };
